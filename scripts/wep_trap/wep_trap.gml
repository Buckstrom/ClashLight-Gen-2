...
function wep_trap(attack){
	...
	switch (check_for_prestige(attack.attacker, attack.trackname)) {
		default:
		case 1:
		//Prestige 1.3: 20% increased dmg
		attack.damage = ceil(attack.damage * 1.2)
		break;
		//Legacy Prestige 1.3: 20% damage bonus to healthy enemies
		case 3:
		var _isExe = _enemy.isExe
		var _healthyThreshold = .5
		var _isHealthy = (_enemy.currentHP / _enemy.maxHP) > _healthyThreshold
		...
		break;
		//Legacy Prestige 1.2: Enemy level * 3 damage bonus
		case 2:
